...
$AIM_IPs = ['6.6.6.6', '6.6.6.7', '6.6.6.8', '10.0.1.66'];
$AIM_subnet = '6.6.6.0/30';
//
// Add here the files that could break bWAPP or your web server in the A.I.M. mode
$AIM_exclusions = ['aim.php', 'ba_logout.php', 'cs_validation.php', 'csrf_1.php', 'http_verb_tampering.php', 'ldap_connect.php', 'ldapi.php', 'portal.php', 'sm_dos_2.php', 'sm_obu_files.php'];
